...
enum RESERVED {
  ...
  TK_GOTO, TK_IF, TK_IN, TK_LOCAL, TK_NIL, TK_NOT,
  TK_BXOR, TK_BLSHIFT, TK_BRSHIFT, TK_ARSHIFT, TK_BLROT, TK_BRROT,
  TK_OR, TK_REPEAT,
  TK_RETURN, TK_THEN, TK_TRUE, TK_UNTIL, TK_WHILE,
  /* other terminal symbols */
  TK_IDIV, TK_CONCAT, TK_DOTS, TK_EQ, TK_GE, TK_LE, TK_NE, TK_NE2, TK_DBCOLON, TK_EOS,
