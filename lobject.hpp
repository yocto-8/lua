...
enum NumParseFlagMask {
  LPARSE_ALLOW_EXPONENT = 1 << 0,
  LPARSE_HEX = 1 << 1,
  LPARSE_SHIFT = 1 << 2,
};


LUA_PURE LUA_FAST LUAI_FUNC int luaO_int2fb (unsigned int x);
LUA_PURE LUA_FAST LUAI_FUNC int luaO_fb2int (int x);
LUA_PURE LUA_FAST LUAI_FUNC int luaO_ceillog2 (unsigned int x);
